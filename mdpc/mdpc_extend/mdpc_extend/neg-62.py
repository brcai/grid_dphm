...
if __name__ == "__main__":
	...
	plt.savefig("C:\\study\\image\\62.png",bbox_inches='tight', pad_inches = 0)
	plt.figure(2)
	pre = [[np.abs(i[j]-255) for j in range(len(i))] for i in weak]
	plt.imshow(pre, cm.gray)
	plt.savefig("C:\\study\\image\\62_pre.png",bbox_inches='tight', pad_inches = 0)
	#plt.show()
	plt.figure(3)
	dataTmp = []
	...
	#dlabel, valid, centers = inst.eval(0.05, 3, 'nl', dataTmp)
	#inst = dp()
	#inst = dpOrig()
	#dlabel, valid, centers = inst.eval(0.08, 9, 'nl', dataTmp)
	...
	#plt.savefig("C:\\study\\image\\62_dpha.png",bbox_inches='tight', pad_inches = 0)
	plt.savefig("C:\\study\\image\\62_dp.png",bbox_inches='tight', pad_inches = 0)
	plt.show()
