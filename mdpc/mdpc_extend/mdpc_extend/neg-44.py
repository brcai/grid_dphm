...
if __name__ == "__main__":
	...
	plt.savefig("C:\\study\\image\\44.png",bbox_inches='tight', pad_inches = 0)
	plt.figure(2)
	pre = [[np.abs(i[j]-255) for j in range(len(i))] for i in weak]
	plt.imshow(pre, cm.gray)
	plt.savefig("C:\\study\\image\\44_pre.png",bbox_inches='tight', pad_inches = 0)
	plt.figure(3)
	dataTmp = []
	...
	#inst = dp()
	#dlabel, valid, centers = inst.eval(0.05, 0.5, 'nl', dataTmp)
	inst = dpOrig()
	...
	#plt.savefig("C:\\study\\image\\44_dpha.png",bbox_inches='tight', pad_inches = 0)
	plt.savefig("C:\\study\\image\\44_dp.png",bbox_inches='tight', pad_inches = 0)
	plt.show()
