import numpy as np
stopWords = ["like","way","make","question","know","read","think","work","time","post","january","author","reply","subject","pm","regard","help","hi", \
	"need","just","us","assign","thank","look","gt","lt","nbsp","a", "about", "above", "able", "across", "after", "afterwards", "again", "against", "all", \
	...
	"since", "sincere", "six", "sixty", "so", "some", "somehow", "someone", "something", "sometime", "sometimes", "somewhere", "still", "such", "take", "ten", \
	"than", "that", "the", "their", "them", "themselves", "then", "thence", "there", "thereafter", "thereby", "therefore", "therein", "thereupon", "these", \
	"they", "thickv", "thin", "third", "this", "those", "though", "three", "through", "throughout", "thru", "thus", "to", "together", "too", "top", "toward", \
...
def euclidean(vec1, vec2):
	tmp = 0.
	for idx, itm in enumerate(vec1):
		tmp += (itm - vec2[idx])**2
	res = np.sqrt(tmp)
	return res

def gaussian(vec1, vec2):
